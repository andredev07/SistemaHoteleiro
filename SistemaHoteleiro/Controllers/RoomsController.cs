...
namespace SistemaHoteleiro.Controllers
{
    ...
    public class RoomsController : Controller
    {
        ...
        {
            var rooms = await _context.Rooms.Include(room => room.CategoryRoom)
        ...
        {
            var categoryRoom = await _context.CategoryRooms.ToListAsync();

            ViewBag.CategoryRooms = categoryRoom.Select(categoryRoom => new SelectListItem
            {
                Value = categoryRoom.Id.ToString(),
                Text = categoryRoom.Description
            });
